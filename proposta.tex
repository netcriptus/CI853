...
a maioria das solu\c{c}\~oes convergem para apenas estender os recursos, 
transformando-se procedimentos paleativos e custosos. Poucas s\~ao as soluções
que não se baseiam inteiramente na maior alocação de
recursos, como a sugerida por ~\cite{Soon:10}, por\'em se mostra inadequadas
